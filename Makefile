...
am__depfiles_remade = ./$(DEPDIR)/arm.Po \
	...
	./$(DEPDIR)/gdb_protocol.Po \
	./$(DEPDIR)/load_store_addressing_operations.Po \
	./$(DEPDIR)/load_store_memory_operations.Po \
	./$(DEPDIR)/memory.Po ./$(DEPDIR)/memory_test.Po \
	./$(DEPDIR)/registers.Po ./$(DEPDIR)/registers_test.Po \
...
COMMON = csapp.h csapp.c scanner.h scanner.l debug.h debug.c \
       ...
       load_store_addressing_operations.c \
       load_store_memory_operations.c
...
include ./$(DEPDIR)/load_store_addressing_operations.Po # am--include-marker
include ./$(DEPDIR)/load_store_memory_operations.Po # am--include-marker
...
distclean: distclean-recursive
	...
	-rm -f ./$(DEPDIR)/load_store_addressing_operations.Po
	-rm -f ./$(DEPDIR)/load_store_memory_operations.Po
